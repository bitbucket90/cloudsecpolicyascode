...
class policies(object):
    ...
    def validate_policies(self,jfin,path_dict,policy_holder,failed_list):
                    ...
                    if process_policy:
                        ...
                        try:
                            ...
                            if add_policy:
                                ...
                                pc["policy_code"] = open(policy_file_path, 'r').read()
                                    ...
                                    for sdict in svc_items:
                                        ...
                                        try:
                                            policy_holder,failed_list = self.validate_policies(
                                                jfin,
                                                path_dict={"parent_path":sdict["parent_path"],"config_path":sdict["config_path"]},
